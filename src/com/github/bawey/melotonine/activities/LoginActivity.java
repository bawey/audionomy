...
import com.github.bawey.melotonine.activities.abstracts.AbstractMenuActivity;
import com.github.bawey.melotonine.singletons.Constants;
import com.perm.kate.api.Auth;

public class LoginActivity extends AbstractMenuActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String url = Auth.getUrl(Constants.VK_API_KEY, Auth.getSettings());
		webview.loadUrl(url);
	}
